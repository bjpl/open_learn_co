...
const categories = ['All', 'Economy', 'Politics', 'Technology', 'Environment', 'Education', 'Finance', 'Infrastructure']
...
function NewsCard({
  ...
  const getSentimentBg = () => {
    switch (sentiment) {
      case 'positive': return 'bg-green-50 dark:bg-green-900/20'
      case 'negative': return 'bg-red-50 dark:bg-red-900/20'
      default: return 'bg-gray-50 dark:bg-gray-700/20'
    }
  }
